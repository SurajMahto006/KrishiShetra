...
export const ProtectedRoute = ({ allowedRoles = [], children }) => {
  ...
  // In staging & local development modes, allow authorized team testing across workspaces
  const isStagingOrDev = import.meta.env.VITE_APP_ENV === 'staging' || import.meta.env.DEV === true;
  if (isStagingOrDev) {
    return <AppShell>{children}</AppShell>;
  }

  // If specific roles are required, check role access (admin is permitted everywhere in production)
