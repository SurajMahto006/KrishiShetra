...
const TransporterData = {
  profile: {
    name: "Vijay More Logistics (Kisan Express)",
    owner: "Vijay More",
    ...
    email: "vijay.more@kisanexpress.in",
    ...
    onTimeDelivery: "97.8%",
    kycStatus: "Verified",
    primaryRoutes: ["Nashik ➔ Vashi APMC", "Pune ➔ Surat APMC", "Indore ➔ Ahmedabad", "Nagpur ➔ Hyderabad"],
    bankDetails: {
      accountName: "Vijay More Logistics Pvt Ltd",
      accountNumber: "50200049281729",
      bankName: "HDFC Bank (Nashik City Branch)",
      ifsc: "HDFC0001048",
      upiId: "vijaymore@hdfcbank"
    }
  },
  ...
  availableLoads: [
    {
      ...
      icon: "🍅",
      fpoName: "Nashik Kisan Samriddhi FPC (Suresh Jadhav)",
      origin: "FPO Collection Point, Nashik (MH)",
      destination: "Vashi APMC Market, Navi Mumbai (MH)",
      distance: "165 km",
      transitEst: "3.5 hrs",
      weightMT: 0.85,
      weightKg: "850 kg",
      truckRequired: "Mahindra Bolero Maxi Truck / Mini",
      ratePerMT: 2800,
      totalPayout: 2380,
      pickupDate: "Today, 06:30 AM",
      perishability: "High",
      tempRequired: "Ventilated Crate Transit",
      urgency: "High Priority",
      notes: "Farmer Ramesh Patil's 850 kg Grade A Tomato. Pick up from FPO Suresh Jadhav to Buyer Amit Shah at Vashi.",
  ...
  activeTrips: [
    {
      ...
      vehicleModel: "Mahindra Bolero Maxi Truck (Insulated)",
      driverName: "Vijay More",
      driverPhone: "+91 98224 55102",
      driverAvatar: "VM",
      commodity: "Grade A Tomato (850 kg)",
      origin: "FPO Collection Point (Suresh Jadhav)",
      destination: "Vashi APMC, Navi Mumbai (Buyer: Amit Shah)",
      status: "Delivered",
      statusBadgeClass: "delivered",
      progressPct: 100,
      currentLocation: "Vashi APMC Receiving Bay 4",
      speedKmh: "0 km/h (Delivered)",
      eta: "Delivered · 12:45 PM",
      totalDistance: "165 km",
      completedDistance: "165 km",
      eWayBill: "EWB-8042-8821-0941",
      reeferTemp: "21°C (Optimal Ambient)",
      tollCrossed: "Vashi Toll Plaza (₹180 paid via FASTag)",
      telemetry: {
        engineHealth: "Optimal (96%)",
        fuelLevel: "74%",
        driverStatus: "Delivered / POD Scale Slip Issued",
        geofence: "Vashi APMC Dock Confirmed"
      }
    },
    {
      id: "TRIP-9022",
